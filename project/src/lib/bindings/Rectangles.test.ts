...
test('minimal construction', () => {
  ...
  rectangles.update([{ id: 1, x: 10, y: 10 }, { id: 2, x: 90, y: 10 }]);
  expect(svg.outerHTML).toMatchInlineSnapshot(
    `"<svg viewBox=\\"0 0 100 100\\"><rect></rect><rect></rect></svg>"`
  );
});
...
test('centered', () => {
  ...
  expect(svg.outerHTML).toMatchInlineSnapshot(
    `"<svg viewBox=\\"0 0 100 100\\"><rect fill=\\"red\\" x=\\"7.5\\" y=\\"7.5\\" width=\\"5\\" height=\\"5\\"></rect><rect fill=\\"red\\" x=\\"87.5\\" y=\\"87.5\\" width=\\"5\\" height=\\"5\\"></rect></svg>"`
  );
});
...
test('centered, missing width and height', () => {
  ...
  rectangles.update([{ id: 1, x: 10, y: 10 }, { id: 2, x: 90, y: 90 }]);
  expect(svg.outerHTML).toMatchInlineSnapshot(
    `"<svg viewBox=\\"0 0 100 100\\"><rect fill=\\"red\\" x=\\"10\\" y=\\"10\\" width=\\"0\\" height=\\"0\\"></rect><rect fill=\\"red\\" x=\\"90\\" y=\\"90\\" width=\\"0\\" height=\\"0\\"></rect></svg>"`
  );
});
